...
zeus_accuracy_graph, zeus_cost_graph= thesis("input_csv_files/other/zeus.csv", 'zeus', 9)
srizbi_fpr, srizbi_tpr, srizbi_threshholds, srizbi_roc_auc, \
srizbi_accuracy_graph, srizbi_cost_graph= thesis("input_csv_files/other/srizbi.csv", 'srizbi', 9)
...
conflicker_accuracy_graph, conflicker_cost_graph= thesis("input_csv_files/other/conflicker.csv", 'conflicker', 9)
...
torpig_accuracy_graph, torpig_cost_graph = thesis("input_csv_files/other/torpig.csv", 'torpig', 9)
...
fig.savefig('/home/ashiq/Pictures/Thesis_image/compDGA_US.eps', format='eps')
plt.show()
